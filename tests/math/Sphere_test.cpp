...
TEST_CASE("Sphere: setFromPoints") {
...
TEST_CASE("Sphere: containsPoint") {
...
TEST_CASE("Sphere: distanceToPoint") {
...
TEST_CASE("Sphere: intersectSphere") {
...
TEST_CASE("Sphere: intersectsBox") {
...
TEST_CASE("Sphere: intersectsPlane") {
...
TEST_CASE("Sphere: getBoundingBox") {
